#!/usr/bin/env bash
#
# deploy-common.sh — the shared parameter block + helpers for kgsm-scheduler's deploy scripts.
#
...
# contract. This copy is vendored so a standalone kgsm-scheduler clone deploys with no umbrella
...
UNITS=("kgsm-scheduler.service")
ENABLE_UNITS=("kgsm-scheduler.service")
