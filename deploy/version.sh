...
#
# The version is declared in exactly ONE place — src/Scheduler/Scheduler.csproj — and read from there, so the package,
...
SOURCE_FILE="${HERE}/../src/Scheduler/Scheduler.csproj"
